...
data:
  ...
  bundledCode: "#line 1 \"geometry/Point.h\"\ntemplate <class T>\nint sgn(T x) {\n\
    ...
    \ tangents(P c1, double r1, P c2, double r2) {\n  P d = c2 - c1;\n  double dr\
    \ = r1 - r2, d2 = d.dist2(), h2 = d2 - dr * dr;\n  if (d2 == 0 || h2 < 0) return\
    \ {};\n  vector<pair<P, P>> out;\n  for (double sign : {-1, 1}) {\n    P v = (d\
    \ * dr + d.perp() * sqrt(h2) * sign) / d2;\n    out.push_back({c1 + v * r1, c2\
...
layout: document
redirect_from:
- /library/geometry/CircleTangents.h
- /library/geometry/CircleTangents.h.html
