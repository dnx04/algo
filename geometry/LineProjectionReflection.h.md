...
data:
  ...
  bundledCode: "#line 1 \"geometry/Point.h\"\ntemplate <class T>\nint sgn(T x) {\n\
    ...
    \ os, P p) {\n    return os << \"(\" << p.x << \",\" << p.y << \")\";\n  }\n};\n\
    #line 2 \"geometry/LineProjectionReflection.h\"\n\ntemplate <class P>\nP lineProj(P\
    \ a, P b, P p, bool refl = false) {\n  P v = b - a;\n  return p - v.perp() * (1\
    \ + refl) * v.cross(p - a) / v.dist2();\n}\n"
  code: "#include \"Point.h\"\n\ntemplate <class P>\nP lineProj(P a, P b, P p, bool\
    \ refl = false) {\n  P v = b - a;\n  return p - v.perp() * (1 + refl) * v.cross(p\
    \ - a) / v.dist2();\n}"
  dependsOn:
  - geometry/Point.h
  ...
  verifiedWith: []
documentation_of: geometry/LineProjectionReflection.h
layout: document
redirect_from:
- /library/geometry/LineProjectionReflection.h
- /library/geometry/LineProjectionReflection.h.html
